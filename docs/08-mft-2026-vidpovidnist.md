...
| Що в документі | Що в коді |
|----------------|-----------|
| ADF на залишках регресії | ✅ є, але **спрощений**: `_adf_test()` без константи й лагів, p-value з дискретних меж `{0.01, 0.05, 0.10, 0.50}` |
...
**Практичний підсумок:** робот `pairs` структурно готовий, але через спрощений ADF він
на реальних ETH/BTC не торгує взагалі (`fills=0`). Найцінніше доопрацювання проєкту —
замінити ADF на `statsmodels.tsa.stattools.coint` (рецепт у [07](07-yak-stvoryty-strategiyu.md#5-приклад-2-замінити-спрощений-adf-на-справжній)).
...
|---|----------|---------|------------|------------|
| 1 | Замінити спрощений ADF на `statsmodels.coint` — оживити `pairs` | 🔥 висока | 🟢 низька | [07 §5](07-yak-stvoryty-strategiyu.md#5-приклад-2-замінити-спрощений-adf-на-справжній) |
